...
def create_board(board):
    board[0] = [Piece('b', 'r', 'b_rook.png'), Piece('b', 'kn', 'b_kn.png'), \
                Piece('b', 'b', 'b_bishop.png'), Piece('b', 'k', 'b_king.png'), \
                Piece('b', 'q', 'b_queen.png'), Piece('b', 'b', "b_bishop.png"), \
                Piece('b', 'kn', 'b_knight.png'), Piece('b', 'r', 'b_rook.png')]

    board[7] = [Piece('w', 'r', 'w_rook'), Piece('w', 'kn', 'w_knight.png'), \
                Piece('w', 'b', 'w_bishop.png'), Piece('w', 'k', 'w_king.png'), \
                Piece('w', 'q', 'w_queen.png'), Piece('w', 'b', 'w_bishop.png'), \
                Piece('w', 'kn', 'w_knight'), Piece('w', 'r', 'w_rook.png')]
            ...
            if on_board((index[0] - 1 + y, index[1] - 1 + x)):
                if board[index[0] - 1 + y][index[1] - 1 + x] == ' ':
                    ...
                    if board[index[0] - 1 + y][index[1] - 1 + x].team != board[index[0]][index[1]].team:
                        board[index[0] - 1 + x].killable = True
    return board
...
def rook_moves(index):
    cross = [[[index[0] + i, index[1]] for i in range(1, 8 - index[0])],
             ...
             [[index[0] - i, index[1]] for i in range(1, 8 - index[1])],
...
def bishop_moves(index):
    diagnals = [[[index[0] + i, index[1] + i] for i in range(1, 8)],
                [[index[0] + i, index[1] - i] for i in range(1, 8)],
                [[index[0] - i, index[1] + i] for i in range(1, 8)],
                [[index[0] - i, index[1] - i] for i in range(1, 8)]]

    for direction in diagnals:
        for positions in direction:
            if on_board(positions):
                if board[positions[0]][positions[1]] == ' ':
                    board[positions[0]][positions[1]] = 'x '
...
pygame.display.set_caption("Toni's Chesseria")
WHITE = (255, 255, 255)
GREY = (128, 128, 128)
YELLOW = (204, 204, 0)
BLUE = (50, 255, 255)
...
def Do_Moves(OriginalPos, FinalPosition, WIN):
